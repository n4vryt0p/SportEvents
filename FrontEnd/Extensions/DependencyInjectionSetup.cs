...
public static class DependencyInjectionSetup
{
    public static IServiceCollection RegisterDiServices(this IServiceCollection services, ConfigurationManager cfgs, string? pCert)
    {
        ...
        _ = services.AddDataProtection().SetApplicationName("ManageEngine");
        //distribute cache
        ...
        _ = services.AddSingleton<ISportEventApi, SportEventApi>();
        //_ = services.AddSingleton<ITicketStore, InMemoryTicketStore>();
